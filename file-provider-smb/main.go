...
func main() {
	...
	fx.New(
		...
		fx.Invoke(func(params fileprovider.ServerParams, viper *viper.Viper, logger *logging.Logger, discovery servicediscovery.ServiceDiscovery, lc fx.Lifecycle) error {
			id := viper.GetString("fileprovider.id")
