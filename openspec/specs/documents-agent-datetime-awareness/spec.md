# Capability: Documents Agent Date/Time Awareness

## Purpose

Give Seraph's documents chat agent awareness of the current date and time, both through a tool and through a one-time prompt injection, so it can reason about document recency and answer time-sensitive questions.
